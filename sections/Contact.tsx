...
const Contact = () => {
  return (
    <section
      className="py-40 relative overflow-hidden bg-[#0e0e0e]"
      id="connect"
    >
          ...
          >
            <div className="space-y-6">
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-headline font-bold mb-10 tracking-tighter text-white leading-none">
                Establish <br />{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8ff5ff] via-[#ac89ff] to-[#8995ff]">
                  Connection
                </span>
              </h2>
              <p className="text-neutral-400 text-lg md:text-xl lg:text-2xl font-light leading-relaxed max-w-lg">
                Open for architectural consultations, strategic engineering
                roles, and collaborative world-building.
              </p>
            </div>
            ...
            <div className="space-y-8 pt-10">
              ...
              >
                ...
                <div className="space-y-1">
                  <span className="text-[10px] uppercase tracking-[0.3em] text-neutral-500 font-bold block">
                    Identity_String
                  </span>
                  <span className="text-white text-lg font-headline font-medium group-hover:text-[#8ff5ff] transition-colors">
                    terminal@pemtshewang.dev
                  </span>
                </div>
              </a>
              ...
              <a href="#" className="flex items-center gap-6 group w-fit">
                ...
                <div className="space-y-1">
                  ...
                  <span className="text-white text-lg font-headline font-medium group-hover:text-[#ac89ff] transition-colors">
          ...
          >
            <form className="space-y-10 p-10 md:p-14 rounded-3xl bg-white/[0.01] border border-white/5 hover:border-white/10 transition-all duration-500">
              <div className="space-y-4">
                <label className="text-[10px] font-headline font-bold uppercase tracking-[0.4em] text-neutral-500">
                  Payload_Sender
                </label>
                <input
